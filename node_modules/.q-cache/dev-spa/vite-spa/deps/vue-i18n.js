import {
  ...
  watch
} from "./chunk-T3ICMWWH.js";
import "./chunk-PZ5AY32C.js";

// node_modules/@intlify/core-base/node_modules/@intlify/shared/dist/shared.mjs
...
var measure2;
if (true) {
  const perf2 = inBrowser2 && window.performance;
  if (perf2 && perf2.mark && perf2.measure && perf2.clearMarks && // @ts-ignore browser compat
  perf2.clearMeasures) {
    mark2 = (tag) => {
      perf2.mark(tag);
...
var isEmptyObject2 = (val) => isPlainObject2(val) && Object.keys(val).length === 0;
var assign2 = Object.assign;
var _create2 = Object.create;
var create2 = (obj = null) => _create2(obj);
var _globalThis2;
var getGlobalThis2 = () => {
...
function getWarnMessage2(code, ...args) {
  return format3(warnMessages2[code], ...args);
}
    ...
    if (!key.includes(".")) {
      ...
      for (let i = 0; i < lastIndex; i++) {
        ...
        if (!isObject2(currentObj[subKeys[i]])) {
          warn2(getWarnMessage2(I18nWarnCodes.IGNORE_OBJ_FLATTEN, {
            key: subKeys[i]
          }));
          hasStringValue = true;
          break;
...
function getLocaleMessages(locale, options) {
  ...
  const ret = isPlainObject2(messages) ? messages : isArray2(__i18n) ? create2() : { [locale]: create2() };
  if (isArray2(__i18n)) {
...
function getCurrentInstance2() {
  if ("currentInstance" in vue_runtime_esm_bundler_exports) {
    const name = "currentInstance";
    return vue_runtime_esm_bundler_exports[name];
  } else {
...
function createComposer(options = {}) {
  ...
  const _ref = inBrowser2 ? ref : shallowRef;
  ...
  const _datetimeFormats = _ref(isPlainObject2(options.datetimeFormats) ? options.datetimeFormats : { [_locale.value]: {} });
  const _numberFormats = _ref(isPlainObject2(options.numberFormats) ? options.numberFormats : { [_locale.value]: {} });
    ...
    isNumber2(ret) && ret === NOT_REOSLVED || warnType === "translate exists" && !ret) {
      ...
      if (__root && isString2(key) && isResolvedTranslateMessage(warnType, arg2)) {
        if (_fallbackRoot && (isTranslateFallbackWarn(_fallbackWarn, key) || isTranslateMissingWarn(_missingWarn, key))) {
          warn2(getWarnMessage2(I18nWarnCodes.FALLBACK_TO_ROOT, {
            key,
            type: warnType
          }));
        }
  ...
  function d(...args) {
    return wrapWithDeps((context) => Reflect.apply(datetime, null, [context, ...args]), () => parseDateTimeArgs(...args), "datetime format", (root) => Reflect.apply(root.d, root, [...args]), () => MISSING_RESOLVE_VALUE, (val) => isString2(val) || isArray2(val));
  }
  function n(...args) {
    return wrapWithDeps((context) => Reflect.apply(number, null, [context, ...args]), () => parseNumberArgs(...args), "number format", (root) => Reflect.apply(root.n, root, [...args]), () => MISSING_RESOLVE_VALUE, (val) => isString2(val) || isArray2(val));
  }
  function normalize(values) {
    return values.map((val) => isString2(val) || isNumber2(val) || isBoolean2(val) ? createTextNode(String(val)) : val);
  }
  ...
  function translateVNode(...args) {
    return wrapWithDeps((context) => {
      ...
      return ret;
    }, () => parseTranslateArgs(...args), "translate", (root) => root[TranslateVNodeSymbol](...args), (key) => [createTextNode(key)], (val) => isArray2(val));
  }
  function numberParts(...args) {
    return wrapWithDeps((context) => Reflect.apply(number, null, [context, ...args]), () => parseNumberArgs(...args), "number format", (root) => root[NumberPartsSymbol](...args), NOOP_RETURN_ARRAY, (val) => isString2(val) || isArray2(val));
  }
  function datetimeParts(...args) {
    return wrapWithDeps((context) => Reflect.apply(datetime, null, [context, ...args]), () => parseDateTimeArgs(...args), "datetime format", (root) => root[DatetimePartsSymbol](...args), NOOP_RETURN_ARRAY, (val) => isString2(val) || isArray2(val));
  }
  ...
  function te(key, locale2) {
    return wrapWithDeps(() => {
      ...
      return isMessageAST(resolved) || isMessageFunction(resolved) || isString2(resolved);
    }, () => [key], "translate exists", (root) => {
      return Reflect.apply(root.te, root, [key, locale2]);
    }, NOOP_RETURN_FALSE, (val) => isBoolean2(val));
  }
...
function vTDirective(i18n) {
  const _process = (binding) => {
    if (true) {
      warnOnce2(getWarnMessage2(I18nWarnCodes.DEPRECATE_TRANSLATE_CUSTOME_DIRECTIVE));
    }
  ...
  const register = (el, binding) => {
    ...
    if (inBrowser2 && i18n.global === composer) {
  ...
  const unregister = (el) => {
    if (inBrowser2 && el.__i18nWatcher) {
      el.__i18nWatcher();
...
function createI18n(options = {}) {
  ...
  if (__legacyMode) {
    warnOnce2(getWarnMessage2(I18nWarnCodes.DEPRECATE_LEGACY_MODE));
  }
...
function useI18n(options = {}) {
  ...
  if (scope === "parent") {
    ...
    if (composer2 == null) {
      if (true) {
        warn2(getWarnMessage2(I18nWarnCodes.NOT_FOUND_PARENT_SCOPE));
      }
      composer2 = gl;
    }
    return composer2;
  ...
  if (composer == null) {
    ...
    if (scope === "local") {
      warn2(getWarnMessage2(I18nWarnCodes.DUPLICATE_USE_I18N_CALLING));
    }
  }
  return composer;
}
